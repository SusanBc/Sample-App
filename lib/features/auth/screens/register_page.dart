...
import 'package:omwaynews/config/validators.dart';
                ...
                CustomButton(
                  ...
                  onPressed: () async {
                    if (formKey.currentState!.validate()) {
                      ...
                      final resp =
                          await AuthRepository.registerUser(data: datas);
                      ...
                      if (resp.error) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text("User Created In Successfully")));
